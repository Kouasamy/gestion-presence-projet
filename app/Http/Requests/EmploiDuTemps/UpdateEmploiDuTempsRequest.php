...
class UpdateEmploiDuTempsRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'seances.*.id' => 'nullable|exists:seances,id',
    ...
    public function messages(): array
    {
        return [
            ...
            'seances.*.id.exists' => 'La séance sélectionnée n\'existe pas.',
            'seances.*.classe_id.required' => 'La classe est obligatoire.',
            'seances.*.classe_id.exists' => 'La classe sélectionnée n\'existe pas.',
