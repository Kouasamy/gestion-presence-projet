            ...
            <div class="p-6 bg-white border-b border-gray-200 relative">
                ...
                <form action="{{ route('coordinateur.emploiDuTemps.store') }}" method="POST">
                    ...
                    <div class="mb-6">
                        ...
                        <select name="classe_id" id="classe_id" class="w-full border-gray-300 rounded-md shadow-sm focus:border-[#e11d48] focus:ring focus:ring-[#e11d48] focus:ring-opacity-50" required>
                    ...
                    <!-- Emploi du temps -->
                    <div class="mb-6">
                        <h2 class="text-lg font-medium text-gray-800 mb-4">Planification des séances</h2>
                                            ...
                                            <td class="p-6 border border-[#3d4270] text-lg h-20 align-middle">
                                                <div class="bg-[#3d4270] rounded-lg p-4">
                                                    <div class="mb-3">
                                                        ...
                                                        <select name="seances[{{ $periode }}_{{ $jour }}][matiere_id]" class="w-full bg-[#3d4270] border-0 rounded-md shadow-sm focus:border-[#e11d48] focus:ring focus:ring-[#e11d48] focus:ring-opacity-50 text-white">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <select name="seances[{{ $periode }}_{{ $jour }}][enseignant_id]" class="w-full bg-[#3d4270] border-0 rounded-md shadow-sm focus:border-[#e11d48] focus:ring focus:ring-[#e11d48] focus:ring-opacity-50 text-white">
                                                            <option value="">Sélectionner</option>
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <select name="seances[{{ $periode }}_{{ $jour }}][type_cours_id]" class="w-full bg-[#3d4270] border-0 rounded-md shadow-sm focus:border-[#e11d48] focus:ring focus:ring-[#e11d48] focus:ring-opacity-50 text-white">
                                                            <option value="">Sélectionner</option>
                                                    ...
                                                    <input type="hidden" name="seances[{{ $periode }}_{{ $jour }}][heure_debut]" value="{{ $periode == 'matin' ? '09:00' : '13:30' }}" class="periode-{{ $periode }}-debut">
                                                    <input type="hidden" name="seances[{{ $periode }}_{{ $jour }}][heure_fin]" value="{{ $periode == 'matin' ? '12:00' : '16:30' }}" class="periode-{{ $periode }}-fin">

                                                    <input type="hidden" name="seances[{{ $periode }}_{{ $jour }}][jour]" value="{{ $jour }}">
                                                    <input type="hidden" name="seances[{{ $periode }}_{{ $jour }}][periode]" value="{{ $periode }}">
                                                    <input type="hidden" name="seances[{{ $periode }}_{{ $jour }}][date_seance]" class="date-seance">
                                                </div>
                                            </td>
                                        @endforeach
                                    </tr>
