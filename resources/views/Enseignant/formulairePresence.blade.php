...
<div class="form-wrapper">
    <div class="form-card">
        <div class="form-header">
            ...
            <a href="{{ route('enseignant.listeSeances') }}" class="text-white opacity-80 hover:opacity-100">
                Retour à la liste
        ...
        <form action="{{ route('enseignant.enregistrerPresence', $seance->id) }}" method="POST" class="space-y-6">
            @csrf
