...
@section('content')
    <div class="container mx-auto p-4 animate-fadeIn">
        <header class="mb-8">
            <h1 class="text-3xl font-bold text-[#202149]">
                👋 Bonjour, <span class="text-[#E61845]">{{ Auth::user()->nom }}</span>
            </h1>
            <p class="text-[#202149]">Bienvenue sur votre espace personnalisé.</p>
        </header>

        {{-- Notifications --}}
        @if ($notifications->isNotEmpty())
            <div class="bg-[#f8d7da] border-l-4 border-[#f5c6cb] text-[#721c24] p-4 mb-6 shadow-md rounded-lg animate-slideIn">
                <div class="flex">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
            ...
            <a href="{{ route('parent.emploiDuTemps') }}" class="card-placeholder group hover:bg-[#202149] hover:text-white transition duration-300 ease-in-out">
            ...
            {{-- Carte Absences --}}
            <a href="{{ route('parent.absences') }}" class="card-placeholder group hover:bg-[#202149] hover:text-white transition duration-300 ease-in-out">
                <div class="text-center">
        ...
        @if ($etudiants->isNotEmpty())
            @foreach ($etudiants as $etudiant)
                <div class="bg-[#f0f0f5] shadow-lg rounded-xl p-6 border-t-4 border-[#202149] mb-6">
                    <h2 class="text-2xl font-bold text-gray-800 mb-4">Informations sur l'Étudiant</h2>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        {{-- Détails de l'étudiant --}}
                        <div class="bg-[#e6e6f0] p-4 rounded-lg">
            ...
            @endforeach
        @else
            <div class="bg-[#d1ecf1] border-l-4 border-[#bee5eb] text-[#0c5460] p-4" role="alert">
