...
@section('title', 'Liste des Statuts de Présence')
        ...
        <div class="bg-white overflow-hidden shadow-sm rounded-lg">
            <div class="p-6 bg-white border-b border-gray-200">
                <div class="flex justify-between items-center mb-6">
                    ...
                    <a href="{{ route('admin.statut-presences.create') }}" class="custom-button">
                ...
                <div class="overflow-x-auto">
                    <table class="custom-table">
                        ...
                        <tbody>
                            @foreach($statutPresences as $statut)
                                <tr>
                                    ...
                                    <td class="flex gap-2">
                                        <a href="{{ route('admin.statut-presences.edit', $statut->id) }}" 
                                           class="custom-button bg-yellow-500 hover:bg-yellow-600">
                                            <i class="fas fa-edit mr-2"></i>
                                            Modifier
                                        </a>
                                        <form action="{{ route('admin.statut-presences.destroy', $statut->id) }}" 
                                              method="POST" 
                                              class="inline-block"
