...
<body>
    ...
    <div class="form-wrapper">
        <form action="{{ route('admin.statutpresence.update', $statut->id) }}" method="POST" novalidate>
    @csrf
    @method('PUT')

    <a href="{{ route('admin.statutpresence.liste') }}" class="role-list-link" title="Liste des statuts de présence">
    ...
    <input type="text" name="nom_statut_presence" placeholder="Nom du statut de présence" required value="{{ old('nom_statut_presence', $statut->nom_statut_presence) }}" />
