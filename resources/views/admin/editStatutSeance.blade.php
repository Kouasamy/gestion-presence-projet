...
<body>
    ...
    <div class="form-wrapper">
        <form action="{{ route('admin.statutseance.update', $statut->id) }}" method="POST" novalidate>
    @csrf
    @method('PUT')

    <a href="{{ route('admin.statutseance.liste') }}" class="role-list-link" title="Liste des statuts de séance">
    ...
    <input type="text" name="nom_seance" placeholder="Nom de la séance" required value="{{ old('nom_seance', $statut->nom_seance) }}" />
