...
<body>
    ...
    <div class="form-wrapper">
        <form action="{{ route('admin.roles.store') }}" method="post" novalidate>
            ...
            <a href="{{ route('admin.roles.index') }}" class="role-list-link" title="Listes des roles">
                listes des roles
            ...
            <input type="text" name="nom_role" placeholder="Nom du rôle" required value="{{ old('nom_role') }}" />
