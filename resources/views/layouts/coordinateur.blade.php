        ...
        <div id="mobile-menu" class="mobile-menu">
            ...
            <ul>
                ...
                <li class="{{ request()->routeIs('coordinateur.seances.*') ? 'active' : '' }}">
                    <a href="{{ route('coordinateur.seances.index') }}" class="{{ request()->routeIs('coordinateur.seances.*') ? 'active' : '' }}">
                ...
                <li class="{{ request()->routeIs('coordinateur.statistiques') ? 'active' : '' }}">
                    <a href="{{ route('coordinateur.statistiques') }}" class="{{ request()->routeIs('coordinateur.statistiques') ? 'active' : '' }}">
