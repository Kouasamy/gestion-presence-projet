    ...
    <div class="min-h-screen bg-gray-100">
        ...
        <div id="mobile-menu" class="mobile-menu">
            ...
            <ul>
                ...
                <li class="{{ request()->routeIs('enseignant.listeSeances') ? 'active' : '' }}">
                    <a href="{{ route('enseignant.listeSeances') }}" class="{{ request()->routeIs('enseignant.listeSeances') ? 'active' : '' }}">
                ...
                <li class="{{ request()->routeIs('enseignant.emploiDuTemps') ? 'active' : '' }}">
                    <a href="{{ route('enseignant.emploiDuTemps') }}" class="{{ request()->routeIs('enseignant.emploiDuTemps') ? 'active' : '' }}">
        ...
        <header class="header">
            ...
            <div class="header-icons">
                <x-notification-dropdown :notifications="$etudiantsDroppes ?? collect()" />
